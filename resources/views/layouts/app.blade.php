...
<head>
	...
	{{-- <link href="{!! asset('css/bootstrap-toggle.css') !!}" rel="stylesheet"> --}}
	    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-toggle/2.2.1/css/bootstrap-toggle.css" rel="stylesheet">
...
<!-- end: FOOTER -->
{{-- @include('layouts.partials.event-management') --}}
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-toggle/2.2.1/js/bootstrap-toggle.js"></script>
